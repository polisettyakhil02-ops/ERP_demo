      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 glass-card px-4 py-2 mt-6 text-sm text-[#606060]"
          >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-[#606060] leading-relaxed mb-4 text-base">
              ...
              <p className="text-[#606060] leading-relaxed mb-8 text-base">
            ...
            >
              ...
              <div className="glass-card p-6 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#606060] text-sm">Incorporated in India</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="w-4 h-4 text-[#b5915a]" />
                  <span className="text-[#606060] text-sm">H. No. 6-3-1093/406, V V Vintage Boulevard, Somajiguda, Hyderabad – 500082</span>
                </div>
                <div className="flex items-center gap-3">
                  <Users className="w-4 h-4 text-[#b5915a]" />
                  <span className="text-[#606060] text-sm">Cross-functional team across development, design & infrastructure</span>
                </div>
              </div>
            </motion.div>
          </div>
